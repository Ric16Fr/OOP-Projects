...
public class myMedia {
	...
	public void writeObject(Medien m) throws FileNotFoundException, IOException{
		ObjectOutputStream o = new ObjectOutputStream(new FileOutputStream("C:\Users\Richard\Aufgabe1\\"+ m.title + ".dat"));
		o.writeObject(m);
		o.flush();
		o.close();
	}
